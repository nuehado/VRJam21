...
namespace PaintIn3D
{
	...
	public class P3dModel : MonoBehaviour
	{
		...
		/// <summary>The hash of this instance used for de/serialization.</summary>
		public int Hash { get { return hash; } } [SerializeField] protected int hash;
		...
		{
			hash = P3dSerialization.TryRegister(this);
		}
